...
- Signature / Nom / Titre professionnel / Coordonnées: left blank for manual signing in Acrobat
- signatoryName, signatoryTitle, signatoryCoordonnees columns exist in DB but are not filled in the PDF (reserved for future use)
