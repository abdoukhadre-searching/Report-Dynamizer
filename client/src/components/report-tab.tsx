                      ...
                      {showHeatingStrategy && (
                        <>
                          ...
                          >
                            ...
                            <p className="text-xs text-muted-foreground mb-2">
                              Ajout de {thermopompeCount} Thermopompes d'au
                              moins 12 000 btu, 10 HSPF2 et 23 SEER2.
                            </p>
                            <AnnexImageUpload
                          ...
                          <div className="print:break-after-page">
                            <h3 className="text-sm font-semibold mb-2">
                              (suite) Thermopompes — Spécifications techniques
                              (page 2)
                            </h3>
                            <img
                          ...
                          <div className="print:break-after-page">
                            <h3 className="text-sm font-semibold mb-2">
                              (suite) Thermopompes — Caractéristiques ASHP (page
                              3)
                            </h3>
                            <img
                              src={ashpPage1Path}
